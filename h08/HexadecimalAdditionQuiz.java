...
/**
 * TextIO from the textbook Gives you a hexadecimal addition quiz and grades
 * your quiz.
 * 
...
public class HexadecimalAdditionQuiz {
  ...
  // private static int[] secondNumbers; // The second numbers in all ten
  // questions.
  private static int[] userAnswers; // The user's answers to the ten questions.
  private static HexAdditionQuestion[] questions;
  ...
  public static void main(String[] args) {
    ...
    System.out.println("answer in hexadecimal");
    System.out.println();
    createQuiz();
    giveQuiz();
    gradeQuiz();
  ...
  private static void createQuiz() {
    ...
    questions = new HexAdditionQuestion[10];
    for (int i = 0; i < 10; i++) {
      questions[i] = new HexAdditionQuestion();
    }
  }
  ...
  private static void giveQuiz() {
    ...
    for (int i = 0; i < 10; i++) {
      int questionNum = i + 1;
      System.out.printf("Q%2d:  %s", questionNum, questions[i].getQuestion());
  ...
  private static void gradeQuiz() {
    ...
    for (int i = 0; i < 10; i++) {
      ...
      System.out.printf("Question %2d: %s  Correct answer is %d ", questionNum, questions[i].getQuestion(),
